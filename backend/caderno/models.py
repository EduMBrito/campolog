...
class UnidadeProdutiva(models.Model):
    nome = models.CharField(max_length=150, help_text="Ex: Campus Petrolina, Fazenda Experimental")
    cnpj_ou_codigo = models.CharField(max_length=50, blank=True, null=True)
    cidade = models.CharField(max_length=100, blank=True, null=True)
    usuarios = models.ManyToManyField(User, related_name='unidades_acessiveis')
...
class RegistoCampo(models.Model):
    ...
    unidade = models.ForeignKey('caderno.UnidadeProdutiva', on_delete=models.CASCADE, related_name='registros')
